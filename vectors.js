...
var arrow1 = new THREE.ArrowHelper(direction1.normalize(), from1, length1, 0xff0000);
...
var arrow2 = new THREE.ArrowHelper(direction2.normalize(), from2, length2, 0xff0000);
...
var arrow3 = new THREE.ArrowHelper(direction3.normalize(), from3, length3, 0xff0000);


var from4 = new THREE.Vector3( 0, 0, 0 );
var to4 = new THREE.Vector3( 0, 0, 3 );
var direction4 = to4.clone().sub(from4);
var arrow4 = new THREE.ArrowHelper(direction4.normalize(), from2, 2, 0xff0000);
...
var arrow5 = new THREE.ArrowHelper(direction5.normalize(), from5, 2, 0xff0000);
